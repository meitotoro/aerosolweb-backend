...
class SitesAODResource(object):
    def on_get(self,req,resp):
        ...
        image_path="/home/mei/aerosolweb-backend/aod-image/"
        data_path = "/home/mei/aerosolweb-backend/data/MODIS/"
        files=os.listdir(image_path)
        name="sarp-aod-"+str(year)+"-"+str(month)+"-"+area+".png"
        print(name)
        for file in files:
            print(file)
            ...
            filename,sites_aod=readhdf.monthMap(data_path, year, month,area)
...
api.add_route('/MODISmap', SitesAODResource())
api.add_route('/MODISmap/{filename}', ImageResource())
